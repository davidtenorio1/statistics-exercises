...
pop_tarts = np.random.normal(3,1.5, (10_000,5))
...
df_men = pd.DataFrame(np.random.normal(178,8, (10_000,1)))
df_women = pd.DataFrame(np.random.normal(170,6, (10_000,1)))
...
fifty_data = np.random.random( (10_000,50))
...
# 100 students?
hundred_data = np.random.random( (10_000,100))
...
first_one_fifty_data = np.random.random( (10_000,150))
...
four_fifty_data = np.random.random( (10_000,450))
...
birthdays = np.random.randint(1,365, (10_000,20))
df_birthdays = pd.DataFrame(birthdays)
df_birthdays['uniques'] = (df_birthdays.nunique(1))
...
birthdays = np.random.randint(1,365, (10_000,40))
df_birthdays = pd.DataFrame(birthdays)
df_birthdays['uniques'] = (df_birthdays.nunique(1))
